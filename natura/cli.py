"""
NATURA COMMAND CENTER (CLI)
Unified entry point exposed via `natura` console script.
"""
import argparse
from natura import GenerativeModel
...
def main():
    ...
    parser.add_argument(
        "mode",
        choices=["chat", "mirage", "genesis", "tycoon", "codex"],
